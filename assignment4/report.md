...
The **multinomial** naive bayes classifier classifies emails based on the amount of times words are present in an email. More general, it uses the frequency of the features to classify.
