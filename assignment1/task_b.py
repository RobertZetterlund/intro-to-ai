...
merged_entries = pd.merge(gdp_entries, life_entries,
                          on=['Code', 'Year', 'Entity'])
...
high_life = merged_entries[merged_entries[HEADER_TITLE_LIFE]
                           > life_mean + life_std * STD_CONSTANT]
# filter based on having low gdp
high_life_low_gdp = high_life[high_life[HEADER_TITLE_GDP]
                              < gdp_mean - gdp_std * STD_CONSTANT]
